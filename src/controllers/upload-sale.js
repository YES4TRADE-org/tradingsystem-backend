...
router.post('/yes4trade/upload-sell', upload.single('image'), async (req, res) => {
    ...
    try {
       ...
       (error, result) => {
           ...
           postProductTrade(title, result.secure_url, price, method_id, studentId, program_id, type_id);
